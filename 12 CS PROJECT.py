...
stuTable = "studetail" 
bookTable = "books" 
issueTable = "issuedetail" 

root = Tk()

root.title("Library Management System by RENEIL")
root.state("zoomed")
...
headingFrame = Frame(root,bd=25, relief=RIDGE)
headingFrame.place(relx=0,rely=0,relwidth=1,relheight=0.2)

heading=Label(headingFrame,font=('Times New ROman', 30, 'bold'), text="Library Management System BY RENEIL")
...
Menu()
root.mainloop()
messagebox.showinfo("THANK YOU","WE WISH YOU TO VISIT AGAIN")
